...
(E)-Clomiphene is represented as a highly lipophilic, highly protein-bound compound with logP of 5.67 and f<sub>u</sub> of 0.08% as summarized in [Section 2.2](#22-data-used). The metabolites are less lipophilic but remain substantially bound, with logP values of 4.17 for (E)-N-desethylclomiphene, 5.50 for (E)-4-hydroxyclomiphene and 3.71 for (E)-4-hydroxy-N-desethylclomiphene [[1](#5-references)].
